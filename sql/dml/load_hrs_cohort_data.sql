...
TRUNCATE TABLE dev_catalog.slv_cdm_hrs.hrs_cohort;
...
SELECT DISTINCT CAST(HACOHORT AS INT) as hacohort_number,
    CASE
    ...
    CASE
        ...
        WHEN CAST(HACOHORT AS INT) = 2 THEN 'CODA (Children of the Depression Age).  Children of Depression (CODA) cohort, born 1924 to 1930. This cohort was first interviewed in 1998 and subsequently every two years.'
