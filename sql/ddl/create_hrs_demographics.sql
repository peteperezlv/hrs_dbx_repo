...
CREATE TABLE dev_catalog.slv_cdm_hrs.hrs_demographics (
    ...
    hrs_survey_respondent_id BIGINT NOT NULL COMMENT 'References hrs_respondent table',
    ...
    CONSTRAINT hrs_demographics_hrs_survey_respondent_fk FOREIGN KEY (hrs_survey_respondent_id) REFERENCES dev_catalog.slv_cdm_hrs.hrs_survey_respondent(hrs_survey_respondent_id)
) USING DELTA COMMENT 'Stores RAND HRS Demographics observations in the Silver Common Data Model.';